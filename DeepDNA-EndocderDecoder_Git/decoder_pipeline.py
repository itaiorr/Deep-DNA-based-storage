...
class decoder:
    ...
    def get_labels_from_cpl(self, res_files_path, confidence_level):
        ...
        predictions = [pred.rstrip() for pred in predictions if pred[11] in {'A','C'}]
...
'''
def main_decoder(erasure_fraction=0.04, substitution_fraction=0.0075, almost_correct_fraction=0.016,
...
#main_decoder(erasure_fraction=0.04, substitution_fraction=0.0075, almost_correct_fraction=0.016,
#         inf_path = "/Users/omersabary/Documents/dataNanopore-pilotSep11/inf_itai_final/Nanopore_single_flowcell_v2",
#    out_put_file_path = "out_decoder.bin", file_identifier = {'A', 'C'}, conf_mode="DNN+Conf+CPL")